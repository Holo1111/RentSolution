...
async function _get_contacts_collection (){
    ...
    return await db.collection('profileTenants');
};
...
module.exports.addTenant = async(req,res)=>{
    ...
    let new_contact = new Tenant(name,email,tel,address)
...
//this method returns all the address's that the tenants posted for the landlords to view 
module.exports.list_allTenant = async (req, res) => {
    let collection = await _get_contacts_collection();
...
// this method returns the specific address of a available house to rent for the landlord to to see
module.exports.get_contactTenant = async (req, res) => {
...
//this method updates the profile of the tenant using the update method in the tenant model


module.exports.update_contactTenant = async (req, res) => {
...
module.exports.delete_contactTenant = async (req, res) => {
